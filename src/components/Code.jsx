...
const Code = () => {
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center m-6">
            <h1 className="text-2xl sm:text-4xl text-center font-bold my-4 sm:m-2">Código 30 (Buque con Impedimento de salida)</h1>
            <div className="flex flex-col items-center justify-center mx-4 sm:mx-50 border border-black rounded p-4 bg-amber-100">
        ...
        <hr className="border border-black w-3/4 mx-auto my-6" />
        <div className="flex flex-col items-center justify-center m-6">
            <h1 className="text-2xl sm:text-4xl text-center font-bold my-4 sm:m-2">Código 17 (Previo al zarpe)</h1>
            <div className="flex flex-col items-center justify-center mx-4 sm:mx-50 border border-black rounded p-4 bg-green-100">
                <p className="text-lg text-justify">
